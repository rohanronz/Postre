      ...
      <div className="w-full max-w-md">
        <div className="bg-white/90 dark:bg-gray-900/80 border border-gray-200/70 dark:border-gray-800 rounded-3xl shadow-2xl p-8 animate-pulse">
          ...
          <div className="mb-6 space-y-2">
            <div className="h-8 w-40 bg-gray-200 rounded dark:bg-gray-700" />
            <div className="h-4 w-56 bg-gray-100 rounded dark:bg-gray-800" />
          </div>
          <div className="space-y-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i}>
                <div className="h-4 w-16 bg-gray-200 rounded mb-2 dark:bg-gray-700" />
